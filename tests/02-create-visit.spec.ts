...
import {CreateNewPatient} from "./POM/Create_New_patient.page";
import {EditinsuranceDetails} from './POM/insuranceDetails.page';



const VMUrl ='http://dev-testing.andalusiagroup.net:5001/medical/visits-management/visit-management/visit-management';
